...
function onProjectsCompaniesHover()
{
	if (!isMobile()) {
		$(".projects-companies-button").attr('src', 'assets/graphics/projects_companies_hover.png');
    }
}

function offProjectsCompaniesHover()
{
	if (!isMobile()) {
		$(".projects-companies-button").attr('src', 'assets/graphics/projects_companies.png');
    }
}
